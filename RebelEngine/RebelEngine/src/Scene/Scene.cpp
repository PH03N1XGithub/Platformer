...
void Scene::Serialize(String name)
{
    ...
    m_Serializer.BeginObject("Lighting");

    m_Serializer.BeginObject("DirectionalLight");
    m_Serializer.Write("DirectionX", m_LightingData.DirectionalLight.Direction.x);
    m_Serializer.Write("DirectionY", m_LightingData.DirectionalLight.Direction.y);
    m_Serializer.Write("DirectionZ", m_LightingData.DirectionalLight.Direction.z);
    m_Serializer.Write("ColorX", m_LightingData.DirectionalLight.Color.x);
    m_Serializer.Write("ColorY", m_LightingData.DirectionalLight.Color.y);
    m_Serializer.Write("ColorZ", m_LightingData.DirectionalLight.Color.z);
    m_Serializer.Write("Intensity", m_LightingData.DirectionalLight.Intensity);
    m_Serializer.Write("SpecularIntensity", m_LightingData.DirectionalLight.SpecularIntensity);
    m_Serializer.Write("SpecularPower", m_LightingData.DirectionalLight.SpecularPower);
    m_Serializer.EndObject();

    m_Serializer.BeginObject("SkyAmbient");
    m_Serializer.Write("SkyColorX", m_LightingData.SkyAmbient.SkyColor.x);
    m_Serializer.Write("SkyColorY", m_LightingData.SkyAmbient.SkyColor.y);
    m_Serializer.Write("SkyColorZ", m_LightingData.SkyAmbient.SkyColor.z);
    m_Serializer.Write("GroundColorX", m_LightingData.SkyAmbient.GroundColor.x);
    m_Serializer.Write("GroundColorY", m_LightingData.SkyAmbient.GroundColor.y);
    m_Serializer.Write("GroundColorZ", m_LightingData.SkyAmbient.GroundColor.z);
    m_Serializer.Write("Intensity", m_LightingData.SkyAmbient.Intensity);
    m_Serializer.EndObject();

    m_Serializer.BeginObject("Environment");
    m_Serializer.Write("UseEnvironmentMap", m_LightingData.Environment.UseEnvironmentMap);
    m_Serializer.Write("DiffuseIBLIntensity", m_LightingData.Environment.DiffuseIBLIntensity);
    m_Serializer.Write("SpecularIBLIntensity", m_LightingData.Environment.SpecularIBLIntensity);
    m_Serializer.EndObject();
...
bool Scene::Deserialize(const String& filename)
{
    ...
    m_Serializer.BeginObjectRead("Lighting");
    {
        m_Serializer.BeginObjectRead("DirectionalLight");
        m_Serializer.Read("DirectionX", m_LightingData.DirectionalLight.Direction.x);
        m_Serializer.Read("DirectionY", m_LightingData.DirectionalLight.Direction.y);
        m_Serializer.Read("DirectionZ", m_LightingData.DirectionalLight.Direction.z);
        m_Serializer.Read("ColorX", m_LightingData.DirectionalLight.Color.x);
        m_Serializer.Read("ColorY", m_LightingData.DirectionalLight.Color.y);
        m_Serializer.Read("ColorZ", m_LightingData.DirectionalLight.Color.z);
        m_Serializer.Read("Intensity", m_LightingData.DirectionalLight.Intensity);
        m_Serializer.Read("SpecularIntensity", m_LightingData.DirectionalLight.SpecularIntensity);
        m_Serializer.Read("SpecularPower", m_LightingData.DirectionalLight.SpecularPower);
        m_Serializer.EndObjectRead();

        m_Serializer.BeginObjectRead("SkyAmbient");
        m_Serializer.Read("SkyColorX", m_LightingData.SkyAmbient.SkyColor.x);
        m_Serializer.Read("SkyColorY", m_LightingData.SkyAmbient.SkyColor.y);
        m_Serializer.Read("SkyColorZ", m_LightingData.SkyAmbient.SkyColor.z);
        m_Serializer.Read("GroundColorX", m_LightingData.SkyAmbient.GroundColor.x);
        m_Serializer.Read("GroundColorY", m_LightingData.SkyAmbient.GroundColor.y);
        m_Serializer.Read("GroundColorZ", m_LightingData.SkyAmbient.GroundColor.z);
        m_Serializer.Read("Intensity", m_LightingData.SkyAmbient.Intensity);
        m_Serializer.EndObjectRead();

        m_Serializer.BeginObjectRead("Environment");
        m_Serializer.Read("UseEnvironmentMap", m_LightingData.Environment.UseEnvironmentMap);
        m_Serializer.Read("DiffuseIBLIntensity", m_LightingData.Environment.DiffuseIBLIntensity);
        m_Serializer.Read("SpecularIBLIntensity", m_LightingData.Environment.SpecularIBLIntensity);
        m_Serializer.EndObjectRead();
    }
    m_Serializer.EndObjectRead();
