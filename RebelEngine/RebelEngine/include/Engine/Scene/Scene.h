...
public:
	...
	struct SkyAmbientData
	{
		Vector3 SkyColor = Vector3(1.0f, 1.0f, 1.0f);
	...
	struct LightingData
	{
		...
		SkyAmbientData SkyAmbient;
		EnvironmentLightingData Environment;
	};
	...
	LightingData& GetLightingData() { return m_LightingData; }
	const LightingData& GetLightingData() const { return m_LightingData; }
