...
public:
   ...
   const T* GetObjectComponent() const;
	...
	virtual void OnActorBeginOverlap(Actor* otherActor, PrimitiveComponent* myComponent, PrimitiveComponent* otherComponent);
	virtual void OnActorOverlapStay(Actor* otherActor, PrimitiveComponent* myComponent, PrimitiveComponent* otherComponent);
	virtual void OnActorEndOverlap(Actor* otherActor, PrimitiveComponent* myComponent, PrimitiveComponent* otherComponent);
