...
REFLECT_CLASS(SphereComponent, PrimitiveComponent)
    ...
    REFLECT_PROPERTY(SphereComponent, bIsTrigger, EPropertyFlags::VisibleInEditor | EPropertyFlags::Editable);
    REFLECT_PROPERTY(SphereComponent, bGenerateOverlapEvents, EPropertyFlags::VisibleInEditor | EPropertyFlags::Editable);
