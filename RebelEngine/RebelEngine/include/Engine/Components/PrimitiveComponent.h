...
struct PrimitiveComponent : SceneComponent
{
    ...
    virtual void OnComponentBeginOverlap(PrimitiveComponent* other) {}
    virtual void OnComponentOverlapStay(PrimitiveComponent* other) {}
    virtual void OnComponentEndOverlap(PrimitiveComponent* other) {}
