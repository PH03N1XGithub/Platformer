...
REFLECT_CLASS(BoxComponent, PrimitiveComponent)
    ...
    REFLECT_PROPERTY(BoxComponent, bIsTrigger, EPropertyFlags::VisibleInEditor | EPropertyFlags::Editable);
    REFLECT_PROPERTY(BoxComponent, bGenerateOverlapEvents, EPropertyFlags::VisibleInEditor | EPropertyFlags::Editable);
