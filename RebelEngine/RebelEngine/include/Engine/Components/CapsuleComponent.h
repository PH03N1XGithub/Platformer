...
REFLECT_CLASS(CapsuleComponent, PrimitiveComponent)
    ...
    REFLECT_PROPERTY(CapsuleComponent, bIsTrigger, EPropertyFlags::VisibleInEditor | EPropertyFlags::Editable);
    REFLECT_PROPERTY(CapsuleComponent, bGenerateOverlapEvents, EPropertyFlags::VisibleInEditor | EPropertyFlags::Editable);
