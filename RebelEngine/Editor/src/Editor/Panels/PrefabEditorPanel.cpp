...
namespace
{
constexpr char kPrefabViewportWindow[] = "Viewport###PrefabEditorViewport";
constexpr char kPrefabComponentsWindow[] = "Components###PrefabEditorComponents";
constexpr char kPrefabDetailsWindow[] = "Details###PrefabEditorDetails";
...
{
    const ImGuiID dockspaceId = ImGui::GetID("PrefabEditorDockspace");
    ...
    ImGui::DockBuilderDockWindow(kPrefabComponentsWindow, dockLeft);
    ImGui::DockBuilderDockWindow(kPrefabDetailsWindow, dockBottomLeft);
    ImGui::DockBuilderDockWindow(kPrefabViewportWindow, dockMain);
...
void PrefabEditorPanel::Draw(const ImGuiID documentDockId, const ImGuiID documentClassId)
{
    ...
    ImGui::DockSpace(ImGui::GetID("PrefabEditorDockspace"), ImVec2(0.0f, 0.0f), ImGuiDockNodeFlags_None);
    ...
    ImGui::SetNextWindowClass(&panelClass);
    if (ImGui::Begin(kPrefabComponentsWindow))
    {
    ...
    ImGui::SetNextWindowClass(&panelClass);
    if (ImGui::Begin(kPrefabDetailsWindow))
    {
