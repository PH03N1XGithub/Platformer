...
void EditorLayer::Draw(float dt)
{
    ...
    m_PrefabEditor.Draw(m_ShellDocumentDockId, kShellDocumentClassId);
}
...
void EditorLayer::DrawGlobalUtilityWindows()
{
    ...
    if (const AssetHandle openPrefabHandle = m_ContentBrowser.ConsumeOpenPrefabRequest();
        IsValidAssetHandle(openPrefabHandle))
    {
        m_PrefabEditor.Open(openPrefabHandle);
    }
